...
?>
  ...
  <div class="col-lg-12"><p class="p1"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;Dashboard / Insert Staff</p></div>
 ...
 <div class="col-lg-12">
             <div class="panel panel-default">
                   <div class="panel-heading">
                      <span class="glyphicon glyphicon-dashboard"></span> &nbsp; Insert Staff 
            ...
            <div class="col-lg-10">	<center><input type="submit" name="b1" value="Insert Manufacturer" class="form-control btn btn-primary t1"></center></div>
...
$sql="Insert into manufacturer (manufacturer_name,image) values('$title_name','$image')";
if($conn->query($sql)){
